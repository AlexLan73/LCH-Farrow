#include "signal_generator_new.h"
#include <iostream>

namespace radar {

SignalGeneratorNew::SignalGeneratorNew(const LFMParameters& params)
    : params_(params), generator_(params_) {}

SignalGeneratorNew::~SignalGeneratorNew() = default;

bool SignalGeneratorNew::Generate(SignalBuffer& out_buffer, LFMVariant variant) {
    ...
    std::cout << "SignalGeneratorNew: generated " << num_beams << " beams, " << num_samples << " samples each\n";
    return true;
}
